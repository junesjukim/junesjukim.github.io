...
<p align="center">Minimizing Franchise Expansion Risk through "Space-as-a-Service"</p>
...
* **Phase 1: Market Penetration (The Platform)**
    Focus on deploying standard vending-style unmanned stores to capture the intersection of the Unmanned Store Market (CAGR 70%) and the Convenience Food Market (CAGR 15%).

* **Phase 2: Technological Moat (ChefBox Mini)**
    Development of **ChefBox Mini**, a robotic cooking vending machine. Unlike simple vending machines, this unit utilizes robotic arms to cook frozen ingredients on-site, offering "restaurant-quality" hot meals 24/7.
...
<div class="row justify-content-sm-center mt-3">
  <div class="col-sm-6 mt-3 mt-md-0">
    {% include figure.liquid path="assets/img/chefbox_award.jpg" title="Award Ceremony" class="img-fluid rounded z-depth-1" %}
    <p class="text-center">Winning the Best Prize (Left: Sungjoo Kim) </p>
  </div>
</div>
